...
class Router
{
    ...
    private function registerRoutes(): void
    {
        ...
        // 学期管理路由
        $this->addRoute('GET', '/semesters', 'SemesterController', 'index', true);
        $this->addRoute('GET', '/semesters/all', 'SemesterController', 'all', true);
        $this->addRoute('GET', '/semesters/{id}', 'SemesterController', 'show', true);
        $this->addRoute('POST', '/semesters', 'SemesterController', 'store', true);
        $this->addRoute('PUT', '/semesters/{id}', 'SemesterController', 'update', true);
        $this->addRoute('DELETE', '/semesters/{id}', 'SemesterController', 'destroy', true);
    }
